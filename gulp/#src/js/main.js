document.addEventListener('DOMContentLoaded', () => {
	const wordsList = [
		...
		{ russian: 'устал от / надоел / заболел', english: 'sick of' },
		...
		{ russian: 'веселый', english: 'jolly / merry' },
		...
		{ russian: 'сомнения / сомневаться', english: 'doubts / doubt' },
		...
		{ russian: 'добрый', english: 'kind' },
		{ russian: 'одолжить', english: 'borrow' },
		{ russian: 'путешествовать / спотыкаться', english: 'trip' },
		{ russian: 'по знакомству / кумовство', english: 'nepotist' },
		{ russian: 'шнур / кабель', english: 'cord' },
		{ russian: 'разорвать', english: 'rip' },
	...
	// A copy of the list from which we will remove the used words
	let availableWords = [...wordsList];
	...
	function showRandomWord() {
		...
		counter.textContent = availableWords.length;
